    ...
    for seed in seeds:
        ...
        for fold, (train_indices, test_indices) in enumerate(gkf.split(data, data_label, group)):
            ...
            for i in train_indices:
                if i <= 29:
                    syd_diff_index = [i, 30 + i * 7, 30 + i * 7 + 1, 30 + i * 7 + 2, 30 + i * 7 + 3, 30 + i * 7 + 4,
                                      30 + i * 7 + 5, 30 + i * 7 + 6]
                    sydney_augmented_diff_indice.extend(syd_diff_index)
                if 29 < i <= 59:
                    hk_diff_index = [i + 210, 270 + (i - 30) * 7, 270 + (i - 30) * 7 + 1, 270 + (i - 30) * 7 + 2,
                                     270 + (i - 30) * 7 + 3, 270 + (i - 30) * 7 + 4, 270 + (i - 30) * 7 + 5,
                                     270 + (i - 30) * 7 + 6]
